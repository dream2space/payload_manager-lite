from archive.payload_manager_helper import TELEMETRY_PACKET_TYPE_DOWNLINK_PACKET
from test_downlink_protocol import TELEMETRY_PACKET_TYPE_DOWNLINK_START
